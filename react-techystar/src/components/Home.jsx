      ...
      <div className="home4" id="brands">
        <div>
          ...
          <article>
            ...
            >
              <a href="https://www.google.com/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit', alignItems: 'center' }}>
                <AiFillGoogleCircle />
                <p style={{ marginLeft: '8px' }}>Google</p>
              </a>
            ...
            >
               <a href="https://www.amazon.com/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit', alignItems: 'center' }}>
              <AiFillAmazonCircle />
              <p>Amazon</p>
              </a>
            </div>
            ...
            >
               <a href="https://youtube.com/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit', alignItems: 'center' }}>
              <AiFillYoutube />
              <p>Youtube</p>
              </a>
            </div>
            ...
            >
               <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit', alignItems: 'center' }}>
              <AiFillInstagram />
              <p>Instagram</p>
              </a>
            </div>
